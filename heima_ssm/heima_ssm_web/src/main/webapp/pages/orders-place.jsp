	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content"> <!--订单信息-->
				<form action="${pageContext.request.contextPath}/orders/placeOrder.do"
					  method="post">
							...
							<div class="col-md-4 data">
								<div class="input-group date">
									...
									<input type="text" class="form-control pull-right"
										   id="datepicker-a3" name="orderTime" value="">
								</div>
							</div>
<%--							<div class="col-md-2 title">下单时间</div>--%>
<%--							<div class="col-md-4 data">--%>
<%--								<input type="text" class="form-control" name="orderTime" placeholder="下单时间"--%>
<%--									   value="" >--%>
<%--							</div>--%>

							<div class="col-md-2 title">订单详情</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="orderDesc" placeholder="订单详情"
									   value="" >
							</div>
							...
							<div class="col-md-2 title">交易状态</div>
							<div class="col-md-4 data">
					...
					<div class="panel panel-default">
						...
						<div class="row data-type">
							<div class="col-md-2 title">联系人Id</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="联系人Id"
									   name="memberId" value="">
							</div>
